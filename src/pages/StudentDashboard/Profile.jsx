...
import { faMapMarkerAlt, faCalendarAlt, faClock, faArrowUp } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <>
      ...
      <StyledProfileLayout>
        ...
        />
        <img src={profile.imageUrl || '/public/default-user.jpg'} alt={profile.name} />
    ...
    <InfoItem>
      ...
      <InfoValue>{profile.country}</InfoValue>
    </InfoItem>
    <InfoItem>
      <InfoLabel>
    ...
    <InfoItem>
      ...
      <InfoValue>{profile.lessons}</InfoValue>
    </InfoItem>
  </div>
        ...
        <EditIcon onClick={handleEditClick} />
          ...
          I am a self-motivated and a confident graduate student aspiring to become a computer scientist who has an extensive knowledge of 4 years in Computer Science sector. My university life was filled with side-project activities and competition participation. All these extracurricular activities brought not only awards and programming friendly features, but more importantly, invaluable experiences, books and concepts I would not have tried otherwise, and project-based thinking with a can do attitude. However, life is an ongoing journey and I keep learning and exploring.
          </p>
          <InfoItem>
            <InfoLabel>
            ...
            <InfoValue>English, Urdu</InfoValue>
          </InfoItem>
          <AboutSection>
          <SectionTitle>  <span style={{ marginLeft: '10px' }}>🎓</span>Education</SectionTitle>
          <SectionContent style={{ marginLeft: '10px' }}>
            B.Sc. - Software Engineering
            University of Central Punjab, Pakistan, Graduated 2021
          </SectionContent>
        </AboutSection>
        </AdditionalCard>
      </StyledProfileLayout>
      ...
      <Row type="horizontal">
        ...
        {reviews.map((review, index) => (
          <ReviewCard key={index}>
            <ReviewHeader>
              <div>
              <img src="/public/default-user.jpg" alt={review.reviewerName} className={styles.buyerAvatar} />
                <strong>{review.reviewerName}</strong>
                <img  src={review.countryFlag} alt={review.reviewerCountry} className={styles.buyerAvatar}/>
              </div>
              <div>
