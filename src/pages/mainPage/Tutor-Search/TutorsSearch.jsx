...
const allCountries = [
  {
    ...
    flag: "https://static.preply.com/groot/country_flags/4x3/us.svg",
  },
  {
    value: "IN",
    label: "India",
    flag: "https://static.preply.com/groot/country_flags/4x3/in.svg",
  },
  {
    value: "GB",
    label: "United Kingdom",
    flag: "https://static.preply.com/groot/country_flags/4x3/gb.svg",
  },
  {
    value: "CA",
    label: "Canada",
    flag: "https://static.preply.com/groot/country_flags/4x3/ca.svg",
  },
  {
    value: "AU",
    label: "Australia",
    flag: "https://static.preply.com/groot/country_flags/4x3/au.svg",
  },
  {
    value: "PK",
    label: "Pakistan",
    flag: "https://static.preply.com/groot/country_flags/4x3/pk.svg",
  },
];
function TutorsSearch() {
  ...
  useEffect(() => {
    ...
    const isValidSubject = subjects.some(
      (subject) => subject.value === subjectFromQuery
    );
    ...
    if (countryParam) {
      ...
      const isValidCountry = countryArray.every((country) =>
        allCountries.some((c) => c.value === country)
      );
      if (isValidCountry) {
  ...
  let content =
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum, nisi lorem egestas vitaeelit. Phasellus imperdiet, nulla et dictum interdum, nisi lorem egestas vitae.";
            ...
            {TutorsArray.length > 0 ? (
                ...
                >
                      ...
                      <div className="col-3">
                        ...
                        <div className="row">
                          ...
                          <SignupModel
                            ...
                            profilePic={index.profilePhoto}
                            firstNameSignup={index.firstName}
                            lastNameSignup={index.lastName}
                            setVerifyshowModal={setVerifyshowModal}
                            handleShowLoginModal={handleShowLoginModal}
                            SignUpshowModal={SignUpshowModal}
                            Backend_URI={Backend_URI}
                          />
                          {/* {Here was the signup model} */}
                          ...
                          {Object.keys(showScheduleModal).map((tutorId) => (
                            <ScheduleModal
                              key={tutorId}
                              availability={
                                selectedTutor && selectedTutor._id === tutorId
                                  ? selectedTutor.availability
                                  : []
                              }
                              showScheduleModal={showScheduleModal[tutorId]}
                        ...
                        <div className="row">
                          {verified && verified != "null" ? (
                            <button
                              onClick={() => handleOpenChat(index._id)}
                  ...
                  {hovered == index && (
                    <div className="col-4 vid">
                      ...
                      <div className="row">
                        <a
                          href={`/tutor?id=${index._id}&sc=true`}
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          <button
              ...
              <div className="row">
                <div className="col-5" style={{ margin: "auto" }}>
                  <p>
                    <h3>
                      Looks searched email: &quot;{searchQuery.get("email")}
              ...
              <div className="row">
                <div className="col-5" style={{ margin: "auto" }}>
                  <p>
                    <h3>Looks like we can’t find any matches</h3>
                  </p>
                  <p>Try removing some filters to see your top tutors</p>
                </div>
                <div className="col-4">
