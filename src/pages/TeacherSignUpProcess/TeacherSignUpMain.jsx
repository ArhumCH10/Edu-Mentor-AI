...
import SpinnerUI from './startSpinner';
...
function TeacherSignUpMain() {
  ...
  useEffect(() => {
    //console.log('userInfo.userData.userData:',userInfo.userData.userData);
    const checkRegistrationComplete = () => {
      if (userInfo && userInfo.userData && userInfo.userData.userData) {
  ...
  }, [userInfo?.userData?.userData?.registrationCompleted]);
